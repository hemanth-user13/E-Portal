            ...
            <div className="sm:absolute sm:top-3 sm:left-7 text-center sm:text-left">
                <div className="relative size-40 mt-10 ml-5">
                    <svg className="size-full -rotate-90" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <circle cx="18" cy="18" r="16" fill="none" className="stroke-current text-blue-600 dark:text-blue-500" strokeWidth="2" strokeDasharray="140" strokeDashoffset="65" strokeLinecap="round"></circle>
                    </svg>
                    <div className="absolute top-1/2 start-1/2 transform -translate-y-1/2 -translate-x-1/2">
                        <span className="text-center text-2xl font-bold text-blue-600 dark:text-blue-500">75%</span>
                    </div>
                ...
                <div className="relative mt-20">
                    ...
                    >
                        Projects
                        <svg className={`w-4 h-4 transition-transform ${isDropdownOpen ? 'rotate-180' : ''}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            <path d="m6 9 6 6 6-6" />
                        </svg>
                    </button>
                        ...
                        <div className="absolute mt-2 left-0 min-w-[220px] bg-white shadow-md rounded-lg p-2 space-y-1 divide-y divide-gray-200 dark:bg-neutral-100 dark:divide-neutral-700">
                            <div className="py-2">
                                {projects.map((project, index) => (
                                    <a key={index} href="#" className="flex justify-between items-center py-2 px-3 rounded-lg text-sm text-black hover:bg-gray-100 dark:text-neutral-900">
